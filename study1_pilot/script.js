...
(function injectGlobalStyles() {
  ...
  style.innerHTML = `
    ...
    /* ===== Streamlined callout card (used everywhere for consistency) ===== */
    .callout {
      max-width: 760px;
      margin: 0.85em auto;
...
/**
 * Adds a 1s buffer between every page/trial via post_trial_gap, recursively for nested timelines.
 * Does NOT create extra trials (keeps data clean).
 */
...
/** ===== MODIFIED: cents-only helpers + dropdown utilities ===== */
...
/******************************
 * ALGO DRAWS (per-participant; used across pages)
 ******************************/

/** ===== MODIFIED: variable algo transfers (drawn from distribution) ===== */
...
let jsPsych = initJsPsych({
  ...
  on_data_update: data => {
    ...
    /** ===== MODIFIED: record algo draws for analysis/debugging ===== */
...
/******************************
 * INSTRUCTIONS (replaces old instructions; with practice demo)
 * NOTE: Per your request, instruction text is kept as-is.
 ******************************/
...
function buildGameInstructionsHtml() {
  let r1PayoffBox = `
    <div class="callout">
      <div class="callout-title">Round 1: Payoff rules</div>
      <ul>
  ...
  let r2PayoffBox = `
    <div class="callout">
      <div class="callout-title">Round 2: Payoff rules</div>
      <ul>
  ...
  return `
    <div class="page-wrapper">
      <h2 class="page-heading">Decision Game Rules</h2>

      <div class="page-content">
        <h3 class="section-heading">Game setup</h3>
        <p>
          You will play a decision game with <strong>two other players</strong> in <strong>real time</strong>.
          We will match you with the other players once you understand the game.
        </p>
        <p>
          Each game consists of two rounds (with role switching), in each of which players unilaterally decide how to divide their given bonus with other players, who must accept whatever they are given.
          You and the other players will play with <strong>real bonuses</strong>.
        </p>
        <p>
          When the game starts, one of the three players is <strong>randomly chosen to be the Round 1 Giver</strong>.
          The other two players are the <strong>Round 1 Receivers</strong>.
        </p>

        <h3 class="section-heading">Round 1</h3>
        <p>
          The Round 1 Giver <strong>receives a 40¢ bonus</strong> and chooses how much of it to transfer to the two Receivers.
          They can transfer <strong>0¢</strong>, <strong>10¢</strong>, <strong>20¢</strong>, <strong>30¢</strong>, or <strong>40¢</strong>.
          After the Giver has made their decision, the Receivers will be informed about how much the Giver has transferred.
        </p>
        <p>
          Any amount the Giver does not transfer, they keep as a bonus for Round 1.
          The amount the Giver transfers also affects what each of the two Receivers receives as a bonus for Round 1.
          The payoff rules in Round 1 are:
        </p>
        ${r1PayoffBox}
        <p>
          <strong>IMPORTANT:</strong>
          The transferred amount is deducted only once from Giver's bonus and is <strong>not split</strong> between the two Receivers.
          That is, the two Receivers each receive the <strong>full transferred amount</strong>,
          and the Giver only has to transfer that bonus <strong>once</strong>.
        </p>

        <h3 class="section-heading">Round 2</h3>
        <p>
          In Round 2, <strong>roles are reversed</strong>: the two Round 1 Receivers become Givers, and the Round 1 Giver becomes the Receiver.
        </p>
        <p>
          The Round 2 Givers <strong>each receive a 40¢ bonus</strong> and choose how much of it to transfer to the Receiver.
          They can transfer <strong>0¢</strong>, <strong>10¢</strong>, <strong>20¢</strong>, <strong>30¢</strong>, or <strong>40¢</strong>.
          The Givers decide <strong>independently</strong> and do <strong>not</strong> know the other Giver's choice before deciding.
          After both Givers have made their decision, the Receiver will be informed about how much the Givers have transferred.
        </p>
        <p>
          For each Giver, any amount they do not transfer, they keep as a bonus for Round 2.
          The amount that each Giver transfers also affects what the Receiver receives as a bonus for Round 2.
          The payoff rules in Round 2 are:
        </p>
        ${r2PayoffBox}
        <p>
          <strong>IMPORTANT:</strong>
          Each Round 2 Giver can only transfer from the Round 2 bonus. Money received in Round 1 cannot be transferred.
        </p>
        ...
        <p>
          ...
          We label the three players in the below examples Players A, B, and C.
          Player A is randomly chosen to be the Round 1 Giver, and Players B and C are the Round 1 Receivers.
        </p>
...
/******************************
 * COMPREHENSION CHECK (mandatory)
 ******************************/

function buildComprehensionHtml() {
  return `
    <div class="page-wrapper">
      <h2 class="page-heading">Comprehension Check</h2>
      <div class="page-content">
        ...
        <div class="radio-block">
          <div class="radio-q">3) In Round 2, when does each Giver get to know what the other Giver chose to transfer?</div>
          <label><input name="q3" type="radio" value="before" required> Before their own decision</label>
          <label><input name="q3" type="radio" value="after" required> After their own decision</label>
          <label><input name="q3" type="radio" value="not" required> Not at all</label>
        </div>
        ...
        <div class="radio-block">
          <div class="radio-q">5) In Round 2, the Receiver’s bonus is…</div>
          <label><input name="q5" type="radio" value="one" required> determined by only one of the two Givers' transfers</label>
          <label><input name="q5" type="radio" value="sum" required> the sum of both Givers' transfers</label>
        </div>
      </div>
    </div>
  `;
...
let htmlConsent = `
  <div class="page-wrapper">
    ...
    <div class="page-content">
      ...
      <p><strong>TIME INVOLVEMENT:</strong> Your participation will take approximately 4 minutes.</p>
...
let comprehensionCheck = {
  ...
  on_finish: data => {
    ...
    } else if (resp.q3 === 'before' || resp.q3 === 'after') {
...
let comprehensionFeedback = {
  ...
  stimulus: () => {
    if (comprehensionPass) {
      return `
        <div class="page-wrapper">
          <h2 class="page-heading">${statusGreen('You correctly answered all comprehension questions.')}</h2>
    ...
    return `
      <div class="page-wrapper">
        <h2 class="page-heading">${statusRed('You did not correctly answer all comprehension questions.')}</h2>
        <div class="page-content" style="text-align:center;">
...
let searchPlayersScreen = {
  ...
  stimulus: `
    <div class="page-wrapper">
      <h2 class="page-heading">Search for other players</h2>
      <div class="page-content">
        <p>We will try to match you with <strong>two other players</strong> in <strong>real time</strong></p>
        <p>This process may take up to <strong>2 minutes</strong>. If two other players are not found within 2 minutes, you will receive a Prolific completion code, and we will ask you to close this window and return to Prolific to get reimbursed.</p>
...
/******************************
 * GAME PAGES (¢ only; dropdowns; qualitative reasoning)
 ******************************/

/** ===== MODIFIED: Disconnect helper kept (unchanged) ===== */
...
let giverRound1 = {
  ...
  stimulus: `
    ...
    `
        ...
        <div class="callout" id="giver_r1_amount_callout">
          <div class="demo-section" style="margin-bottom:0.9em;">
            <label class="demo-label" for="giver_amount_select">
              How much of your bonus do you want to transfer to the two Receivers?
          ...
          <!-- ===== MODIFIED: qualitative reasoning (appears only after lock-in) ===== -->
        ...
        <!-- ===== MODIFIED: expectation question is now total (0¢–80¢) + reasoning ===== -->
  ...
  on_load: () => {
    ...
    transferBtn.addEventListener('click', () => {
      ...
      // Reveal qualitative reasoning (same callout; post-lock-in).
...
let giverRound2 = {
  ...
  stimulus: `
    ...
    `
            <p>
              For Round 2, the roles are reversed.
...
let giverBonusPage = {
  ...
  stimulus: () => {
    ...
    let receivedRound2 = algoR2TotalToR1GiverCents;
    ...
    return `
      ...
      `
              <p style="margin:0;">
                ...
                Transferred to you in Round 2: ${formatCents(receivedRound2)}<br>
  ...
  stimulus: `
    ...
    `
        ...
        <div class="callout" id="recv_r2_amount_callout">
          ...
          <!-- ===== MODIFIED: qualitative reasoning after lock-in ===== -->
...
let followupTrial = {
  ...
  preamble: `
    <div class="page-wrapper">
      <h2 class="page-heading">Follow-up Question</h2>
      <div class="page-content">
...
/******************************
 * DATAPIPE (fixed: save happens BEFORE redirect)
 ******************************/
...
/******************************
 * FINAL SUBMISSION (allows exit + redirects)
 ******************************/
...
let submitTrial = {
  ...
  stimulus: `
    <div class="page-wrapper">
      <h2 class="page-heading">Return to Prolific</h2>
      <div class="page-content">
